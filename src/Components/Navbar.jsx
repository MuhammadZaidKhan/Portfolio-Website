      ...
      <div className="sticky top-0 w-full h-20 shadow-md z-[100] nav-bg text-white">
        ...
        >
          <div
            className={`${
              nav
                ? "fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-blue bg-opacity-50 p-10 ease-in duration-500"
                : "fixed left-[-100%] top-0 p-10 ease-in duration-500"
            }`}
          >
            <div className="flex w-full items-center justify-between">
              <div class="flex items-center justify-center w-28 h-9  md:px-12 pt-2 pb-2 rounded-2xl logo">
                <span class="text-white font-base text-sm font-poppins">
                  Zaid
                </span>
              </div>
              <div
            ...
            <div className="py-4 flex flex-col font-Inter font-medium">
              <ul className="uppercase">
                ...
                <Link to={"/Certifications"} onClick={() => setNav(false)}>
                  <li className="py-4">Certifications</li>
                </Link>
