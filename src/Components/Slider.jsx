      ...
      <Slider {...settings}>
        ...
        <div className="mx-12 md:ml-10">
          <div className="w-48 h-40 bg-grey">
            ...
            <a
              href="https://react-blog-website-nine.vercel.app/"
              target="_blank"
            >
              <button className="bg-blue font-Montserrat font-normal text-sm leading-7 px-10 ml-7 mt-3 mb-2">
                Live link
              </button>
            </a>
          </div>
        ...
        <div className="mx-12 md:ml-10">
          <div className="w-48 h-40 bg-grey">
            ...
            <a
              href="https://weather-app-one-ashy-79.vercel.app/"
              target="_blank"
            >
              <button className="bg-blue font-Montserrat font-normal text-sm leading-7 px-10 ml-7 mt-7 mb-2">
                Live link
              </button>
            </a>
          </div>
        ...
        <div className="mx-12 md:ml-10">
          <div className="w-48 h-40 bg-grey">
            ...
            <a
              href="https://medium-com-about-page-clone.vercel.app/"
              target="_blank"
            >
              <button className="bg-blue font-Montserrat font-normal text-sm leading-7 px-10 ml-7 mt-4 mb-2">
                Live link
              </button>
            </a>
          </div>
        ...
        <div className="mx-12 md:ml-10">
          <div className="w-48 h-40 bg-grey">
            ...
            <img src={zaid} alt="" className="pt-3" />
            <a
              href="https://muhammadzaidkhan-6f1874.netlify.app/"
              target="_blank"
            >
              <button className="bg-blue font-Montserrat font-normal text-sm leading-7 px-10 ml-7 mt-6 mb-2">
                Live link
