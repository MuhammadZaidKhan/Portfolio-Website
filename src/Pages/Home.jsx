    ...
    <div className="bg-blue min-h-screen text-white overflow-auto">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="pt-10 text-center md:text-start md:pt-20 md:pl-8 space-y-3">
          <h1 className="font-Montserrat font-normal text-4xl">
            Muhammad Zaid Khan
          </h1>
          <h2 className="font-Montserrat font-light text-2xl">
            Full Stack Developer
          </h2>
          <p className="px-3 md:px-0 md:w-5/6 font-Montserrat font-light text-base pt-4 leading-6">
            Welcome to my portfolio website! I'm a versatile web developer
            skilled in front-end development, dedicated to crafting exceptional
